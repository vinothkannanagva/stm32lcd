...
void ST7789_Init(void)
{
   ...
   // ST7789_WriteCommand(ST7789_COLMOD);
    ...
    ST7789_WriteSmallData (0x01);			//	Default value
    ST7789_WriteCommand (0xC3);				//	VRH set
    ST7789_WriteSmallData (0x00);			//	+-4.45v (defalut +-4.1v for 0x0B)
    ST7789_WriteCommand (0xC4);				//	VDV set
    ST7789_WriteSmallData (0x00);			//	Default value
    ST7789_WriteCommand (0xC6);				//	Frame rate control in normal mode
    ST7789_WriteSmallData (0x0F);			//	Default value (60HZ)
    ST7789_WriteCommand (0xD0);				//	Power control
    ST7789_WriteSmallData (0xA4);			//	Default value
...
void ST7789_WriteCharpp(uint32_t x, uint32_t y, uint32_t size,char ch, FontDef font, uint32_t color, uint32_t bgcolor)
{
	uint32_t i, b, j,k;
	//uint32_t size = 6;
	ST7789_Select();
...
void ST7789_WriteStringpp(uint32_t x, uint32_t y, uint32_t size,char *str, FontDef font, uint32_t color, uint32_t bgcolor)
{
	ST7789_Select();//ss pin spi start
