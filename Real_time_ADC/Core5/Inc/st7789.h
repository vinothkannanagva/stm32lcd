...
//#define ST7789_ROTATION 3
    ...
    #define ST7789_WIDTH   240   //def 240
    #define ST7789_HEIGHT  240  //def 240
...
void drawbattery(int lengthstart,int lengthend,int lengthpostop, int lengthposbottom , int heightstart,int heightend,int heightposleft,int heightposright,
int tipleightstart,int tipleightend,int tiplnposstart ,int tiplnosend,int tipheightstr ,int tiphightend,int tiphightpos , int fill_battery);
...
void ST7789_Fill_Color2();
void ST7789_Fill_Color3();
